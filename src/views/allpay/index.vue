  ...
  <div style="background:#eeeeee;padding-top:10px;min-height:1000px;height:auto;">
    ...
    >
      <div style="padding-bottom:10px;padding-top:10px;float:left;width:100%;">
        <el-row>
          <el-col :span="3">
            <div style="margin-top:3px;margin-left:0;font-size:18px;text-align:center;">总支付订单</div>
          </el-col>
          <el-col :span="4">
      ...
      >
        ...
        <el-table-column prop="car_port_name" label="车棚" width="180"></el-table-column>
        <el-table-column prop="user_mobile" label="用户" width="180">
        </el-table-column>
        <el-table-column prop="create_time" label="时间" width="180"></el-table-column>
        <el-table-column prop="business_type" label="business_type" width="180"></el-table-column>
        <el-table-column prop="pay_money" label="pay_money" width="180"></el-table-column>
        <el-table-column prop="pay_type" label="pay_type" width="180"></el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    getData(data) {
      ...
      console.log(data);
      request({
        url: concans.schema+"://" + concans.host + "/contract/adminOrder/payOrder",
        method: "post",
        data: data,
      })
        .then((res) => {
