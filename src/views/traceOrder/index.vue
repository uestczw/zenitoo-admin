  ...
  <div style="background:#eeeeee;padding-top:10px;min-height:1000px;height:auto;">
    ...
    >
      <div style="padding-bottom:10px;padding-top:10px;float:left;width:100%;">
        <el-row>
          <el-col :span="3">
            <div style="margin-top:3px;margin-left:0;font-size:18px;text-align:center;">押金支付订单</div>
          </el-col>
          <el-col :span="4">
      ...
      >
        <el-table-column prop="deposit_sn" label="编号" width="180"></el-table-column>
        ...
        <el-table-column prop="settle_time" label="结算时间" width="180"></el-table-column>
        <el-table-column prop="deposit_money" label="deposit_money" width="180"></el-table-column>
        <el-table-column prop="pay_money" label="pay_money" width="180"></el-table-column>
        <el-table-column prop="refund_money" label="refund_money" width="180"></el-table-column>
        <el-table-column prop="settle_money" label="settle_money" width="180"></el-table-column>
        <el-table-column prop="assess_money" label="assess_money" width="180"></el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    getData(data) {
      ...
      console.log(data);
      request({
        url: concans.schema+"://" + concans.host + "/contract/adminOrder/depositOrder",
        method: "post",
        data: data,
      })
        .then((res) => {
