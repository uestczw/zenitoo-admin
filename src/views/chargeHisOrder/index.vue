  ...
  <div style="background:#eeeeee;padding-top:10px;min-height:1000px;height:auto;">
    ...
    >
      <div style="padding-bottom:10px;padding-top:10px;float:left;width:100%;">
        <el-row>
          <el-col :span="3">
            <div style="margin-top:3px;margin-left:0;font-size:18px;text-align:center;">充电历史订单</div>
          </el-col>
          <el-col :span="4">
      ...
      >
        <el-table-column prop="charge_sn" label="订单编号" width="180"></el-table-column>
        <el-table-column prop="car_port_name" label="车棚名称" width="180"></el-table-column>
        <el-table-column prop="user_mobile" label="用户" width="120">
        </el-table-column>
        <el-table-column prop="start_time" label="开始时间" width="160">
        </el-table-column>
        <el-table-column prop="end_time" label="结束时间" width="160"></el-table-column>
        <el-table-column prop="power" label="电瓶伏数" width="60">
            <template slot-scope="scope">
              {{scope.row.start_power}}-{{scope.row.end_power}}
            </template>
        </el-table-column>
        <el-table-column prop="order_charge_minute" label="实际时间" width="60"></el-table-column>
        <el-table-column prop="user_charge_minute" label="预充时间" width="60"></el-table-column>
        <el-table-column prop="prepare_money" label="预付金额" width="60"></el-table-column>
        <el-table-column prop="order_pay_money" label="实际金额" width="60"></el-table-column>
        <el-table-column prop="refund_money" label="退款金额" width="60"></el-table-column>
        <el-table-column prop="order_charge_hour" label="计费时长" width="60"></el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    getData(data) {
      ...
      data.app_key = 'ZENITOO_PRO';
      console.log(data);
      request({
        url: concans.schema+"://" + concans.host + "/contract/adminOrder/historyChargeList",
        method: "post",
        data: data,
      })
        .then((res) => {
